...
CA.view = {
		...
		initCList : function(){
			...
			//topic edit button
			$('button.edit_t').click(function(){CA.actions.startEdit(tbody.find('tr.selected'));});
			//metainfo edit button
			$('button.edit_m').click(function(){CA.actions.startEdit(tbody.find('tr.selected'), 'meta');});
			//course clone button
			$('button.clone').click(function(){CA.actions.startEdit(tbody.find('tr.selected'), 'clone');});
			//course add button
			...
			//course delete
			$('button.del').click(function(){CA.actions.startEdit(tbody.find('tr.selected'), 'del');});
		},
